	...
	<div class="wrap-fluid" style="margin-left:260px;">
		<div class="container-fluid paper-wrap bevel tlbr">
			...
			<ul id="breadcrumb">
				...
				<li><a href="#" title="Sample page 1">收藏微博</a></li>
			</ul>
                                    ...
                                    <div class="timeline-item">
                                        <span class="time">
											<ul class="list-inline">
												<li><a href="/weibo/uncollect.do?id=<%=article.id%>&puuid=<%=article.uuid%>&path=collect">取消收藏</a>
													&nbsp;&nbsp;<a href="/weibo/delete.do?id=<%=article.id%>&path=collect">删除</a>
												</li>
												&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="timeline-item">
                                       <%
											...
											if(offset==0){
												...
												if("1".equals(isNext)){
													%>
													<a class="timeline-header" href='/weibo/listcollect.do?isNext=0&offset=<%=offset%>'>返回首页</a>
													<%
												}
												%>
												<%
												...
												%>
												<a class="timeline-header" href='/weibo/listcollect.do?isNext=1&offset=<%=offset%>'>下一页</a>
												<%
											}
										%>
                                    </div>
